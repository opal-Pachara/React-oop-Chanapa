        ...
        if(s===1){
            return(
                ...
                <Form>
                    ...
                    <input type="number" id="XLinear" onChange={(event)=>setX(event.target.value)} style={{width:"20%", margin:"0 auto"}} className="form-control"></input>
                    <br></br>
